//
//  RepetitiousCollectionView.swift
//  RepetitiousCollectionView
//
...
public protocol RepetitiousCollectionViewDataSource {
...
public protocol RepetitiousCollectionViewDelegate {
    // Required
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, lengthOfItemAtIndex index: Int) -> CGFloat
    // Optional
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, willSelectItemAtIndex index: Int)
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, didSelectItemAtIndex index: Int)
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, willDeselectItemAtIndex index: Int)
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, didDeselectItemAtIndex index: Int)
...
extension RepetitiousCollectionViewDelegate {
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, willSelectItemAtIndex index: Int) { }
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, didSelectItemAtIndex index: Int) { }
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, willDeselectItemAtIndex index: Int) { }
    func repetitiousCollectionView(repetitiousCollectionView: RepetitiousCollectionView, didDeselectItemAtIndex index: Int) { }
...
public class RepetitiousCollectionView: UIView, UIScrollViewDelegate {
    ...
    private struct Constants {
        ...
        static let ScrollEndDraggingFactor: CGFloat = 400.0
    ...
    public var delegate: RepetitiousCollectionViewDelegate? = nil
    
    public var dataSource: RepetitiousCollectionViewDataSource? = nil
    ...
    private var activeCells: [Int: RepetitiousCollectionViewCell] = [:]
    
    private var reusedClassStore: [String: AnyClass] = [:]
    
    private var reusedCellStore: [String: [RepetitiousCollectionViewCell]] = [:]
    ...
    public func selectItem(atIndex index: Int, animated: Bool) {
        ...
        if let delegate: RepetitiousCollectionViewDelegate = self.delegate {
            delegate.repetitiousCollectionView(self, willSelectItemAtIndex: index)
        }
        ...
        if let delegate: RepetitiousCollectionViewDelegate = self.delegate {
            delegate.repetitiousCollectionView(self, didSelectItemAtIndex: index)
        }
    }
    ...
    public func deselectItem(atIndex index: Int, animated: Bool) {
        ...
        // Call Delegate Method (Will)
        if let delegate: RepetitiousCollectionViewDelegate = self.delegate {
            delegate.repetitiousCollectionView(self, willDeselectItemAtIndex: index)
        }
        ...
        // Call Delegate Method (Did)
        if let delegate: RepetitiousCollectionViewDelegate = self.delegate {
            delegate.repetitiousCollectionView(self, didDeselectItemAtIndex: index)
        }
    }
    ...
    public func dequeueReusableCellWithIdentifier(identifier: String) -> RepetitiousCollectionViewCell {
    
        let _class: RepetitiousCollectionViewCell.Type? = self.reusedClassStore[identifier] as? RepetitiousCollectionViewCell.Type
        if _class == nil {
        ...
        if let cell: RepetitiousCollectionViewCell = self.reusedCellStore[name]?.last {
            // Return Stored Cell
            self.reusedCellStore[name]?.removeLast()
            return cell
        } else {
            // Return New Cell
            let cell: RepetitiousCollectionViewCell = _class!.init()
            return cell
        }
    }
    ...
    public func reloadData() {
        ...
        self.numberOfItems = self.dataSource?.repetitiousCollectionViewNumberOfItems(self) ?? 0
        self.lengthOfItems = (0..<self.numberOfItems).map { (index: Int) -> CGFloat in
            return self.delegate?.repetitiousCollectionView(self, lengthOfItemAtIndex: index) ?? 0.0
        }
    ...
    private func updateVisibleCells() {
        ...
        guard let dataSource: RepetitiousCollectionViewDataSource = self.dataSource else {
            return
        }
        ...
        for (_index, itemIndex) in itemIndexes.enumerate() {
            ...
            if newCellIndexSet.contains(index) {
                ...
                let cell: RepetitiousCollectionViewCell = dataSource.repetitiousCollectionView(self, cellAtIndex: itemIndex)
                ...
                // Cell Will Display
                if let delegate: RepetitiousCollectionViewDelegate = self.delegate {
                    delegate.repetitiousCollectionView(self, willDisplayCell: cell, forItemAtIndex: itemIndex)
                }
        ...
        for index in disableCellIndexSet {
            if let cell = self.activeCells[index] {
                ...
                if let delegate: RepetitiousCollectionViewDelegate = self.delegate {
                    delegate.repetitiousCollectionView(self, didEndDisplaying: cell, forItemAtIndex: cell.itemIndex)
                }
                ...
                var cells: [RepetitiousCollectionViewCell] = []
                if let storedCells: [RepetitiousCollectionViewCell] = self.reusedCellStore[name] {
    ...
    func onCellTapped(sender: UITapGestureRecognizer) {
        ...
        guard let cell: RepetitiousCollectionViewCell = sender.view as? RepetitiousCollectionViewCell else {
            return
        }
    ...
    public func scrollViewDidEndDecelerating(scrollView: UIScrollView) {
        ...
        // Cell Did Focus
        if let delegate: RepetitiousCollectionViewDelegate = self.delegate, cell: RepetitiousCollectionViewCell = self.activeCells[self.centerItem.index] {
            delegate.repetitiousCollectionView(self, didFocusCell: cell, forItemAtIndex: centerItem.itemIndex)
        }
    ...
    public func scrollViewWillEndDragging(scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        case .Horizontal:
            ...
            let target: CGFloat = middle + self.centerItem.origin + Constants.ScrollEndDraggingFactor*velocity.x
        ...
        case .Vertical:
            ...
            let target: CGFloat = middle + self.centerItem.origin + Constants.ScrollEndDraggingFactor*velocity.y
